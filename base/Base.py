...
class Base():
    ...
    class Event(StrEnum):
        ...
        PROGRESS_TOAST_SHOW = "PROGRESS_TOAST_SHOW"                         # 进度通知 - 显示
        PROGRESS_TOAST_UPDATE = "PROGRESS_TOAST_UPDATE"                     # 进度通知 - 更新
        PROGRESS_TOAST_HIDE = "PROGRESS_TOAST_HIDE"                         # 进度通知 - 隐藏
