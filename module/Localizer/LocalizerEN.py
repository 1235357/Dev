...
class LocalizerEN(LocalizerZH):
    ...
    search_regex_invalid: str = "Invalid Regex"
    search_no_match: str = "No Match Found"
    search_regex_btn: str = "Regex"
    search_match_info: str = "{current} / {total}"
    search_no_result: str = "No Result"
    ...
    translation_page_indeterminate_stopping: str = "Stopping translation task …"
    ...
    translation_page_card_token_tooltip: str = "Click to switch Input/Output"
    translation_page_card_zh_chars: str = "Total Characters (ZH)"
    ...
    proofreading_page_export_confirm: str = "Confirm to export translation files?"
    proofreading_page_export_tooltip: str = "Export Translation Files\nSave data first, then generate translation files"
    proofreading_page_col_src: str = "Original"
    ...
    proofreading_page_load_success: str = "Cache loaded successfully ({COUNT} items)"
    proofreading_page_load_failed: str = "Failed to load cache file"
    proofreading_page_save_failed: str = "Failed to save"
    ...
    proofreading_page_status_processed_in_past: str = "History"
    ...
    proofreading_page_warning_glossary: str = "Glossary Failed"
    ...
    basic_settings_page_input_token_threshold_title: str = "Input Token Threshold"
    basic_settings_page_input_token_threshold_content: str = "Maximum number of tokens for input text per task"
    basic_settings_page_output_token_threshold_title: str = "Output Token Threshold"
    basic_settings_page_output_token_threshold_content: str = "Maximum number of tokens for output text per task"
    ...
    expert_settings_page_request_max_retries_title: str = "Request Max Retries"
    expert_settings_page_request_max_retries_desc: str = (
        "Client internal retry count for request failures, 0 = no retry"
        "<br>"
        "Streaming retries are controlled by Streaming Retry Attempts"
    )
    expert_settings_page_stream_stall_timeout_seconds_title: str = "Streaming Stall Timeout (s)"
    expert_settings_page_stream_stall_timeout_seconds_desc: str = (
        "After streaming starts (received at least one chunk), if no chunk is received for this duration, the stream is treated as stalled"
        "<br>"
    ...
    expert_settings_page_stream_retry_backoff_seconds_title: str = "Streaming Retry Backoff Base (s)"
    ...
    glossary_page_table_row_02: str = "Target"
    glossary_page_table_row_04: str = "Source"
